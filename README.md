...
## Instructions
Use this provided Vue app to complete the 2 challenges below (Part 1 & Part 2).  
Once you complete your work, zip this codebase and return it.


### Setup Step 1: In the project directory, install the Vue.js app's dependencies with the following command
```
yarn install
```

### Setup Step 2: Compile & serve for development with the following command
```
yarn serve
```
...
Add a function `getTVShowNames` to this Vue app.
...
Using the provide Vue app, display the data returned from the previous question. 
